...
| `/website`           | Personal website design and portfolio     | website, portfolio site, web design                                           |
...
| `/integrate`         | Esper — source ingestion                  | "integrate", "ingest", "process sources", "feed esper"                        |
| `/esper`             | Esper — query + lint                      | "esper", "ember", "what do I know about", "esper lint", "knowledge check"     |
